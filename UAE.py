    ...
    if button == 'Info':
        ...
        if button1 == 'Analysis of Death Cases based on the Cause, Gender Location':
            ...
            if gender_selection == 'All':
                ...
                col1.subheader("Number of Deaths of Men:")
                col1.write("  ")
                col1.write("  ")
                col1.write("  ")
                col1.write("  ")
                ...
                col3.subheader("Deaths Based on the selected causes for Men:")

                death_2002_2008_M_total=death_2002_2008_M.groupby(['Year'])['Value'].sum().reset_index()
                death_2002_2008_M_total_bar=sns.barplot(x='Year', y='Value',color='Blue', data=death_2002_2008_M_total)
                death_2002_2008_M_total_bar.set(xlabel='Year',ylabel='Total Deaths')
                death_2002_2008_M_total_bar.set_title('Total Number of Men Deaths',y=1.02)
                col1.pyplot()

                #Check the top causes of death on the men
                x = col2.number_input('Enter the number of causes you want to see:',min_value=3,)
                x=int(x)
                ...
                options_M = col3.multiselect('Select Cause of Death: (You can select more than 1)', list_M)
                ...
                if not options_M:
                    col3.warning('Please add cause above.')
                elif options_M:
                ...
                col1.subheader("Number of Deaths of Women:")
                col1.write("  ")
                col1.write("  ")
                col1.write("  ")
                col1.write("  ")
                ...
                col2.subheader("Top Causes of Deaths for Women:")

                col3.subheader("Deaths Based on the selected causes:")

                death_2002_2008_F_total=death_2002_2008_F.groupby(['Year'])['Value'].sum().reset_index()
                death_2002_2008_F_total_bar=sns.barplot(x='Year', y='Value',color='Blue', data=death_2002_2008_F_total)
                death_2002_2008_F_total_bar.set(xlabel='Year',ylabel='Total Deaths')
                death_2002_2008_F_total_bar.set_title('Total Number of Women Deaths',y=1.02)
                col1.pyplot()
                ...
                options_F = col3.multiselect('Select Cause of Death: (You can select more than 1)', list_F)
